...
public class BlogAdmin implements RequestHandler<Map<String, String>, String> {
    private static Logger LOG = Logger.getLogger(BlogAdmin.class.getName());
    ...
    public static void main(String args[]) {
        ...
        LOG.info(new BlogAdmin().handleRequest(input, null));
    }
