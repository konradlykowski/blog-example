...
public class BlogAdder implements RequestHandler<Map<String, String>, String> {
    private static Logger LOG = Logger.getLogger(BlogAdder.class.getName());
    ...
    public static void main(String args[]) {
        ...
        LOG.info(new BlogAdder().handleRequest(input, null));
    }
