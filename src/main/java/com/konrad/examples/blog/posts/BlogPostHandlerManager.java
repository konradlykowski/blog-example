...
public class BlogPostHandlerManager implements RequestHandler<Map<String, String>, String> {
    private static Logger LOG = Logger.getLogger(BlogPostHandlerManager.class.getName());

    public BlogPostHandlerManager() {
    ...
    public static void main(String args[]) {
        ...
        LOG.info(new BlogPostHandlerManager().handleRequest(input, null));
    }
    ...
    public String handleRequest(Map<String, String> input, Context context) {
        ...
        restTemplate.put(input.get("url"), new HttpEntity(input.get("content"), headers));
        return "SUCCEED";
    }
